...
const CompleteProfile = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="relative">
          <div className={`w-24 h-24 rounded-full border-4 ${theme.border.primary} overflow-hidden bg-gray-100 flex items-center justify-center`}>
          ...
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border ${
              errors.fullName 
                ...
                : `${theme.border.primary} ${theme.bg.secondary} ${theme.text.primary} focus:ring-blue-500`
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      ...
      {/* Summary */}
      <div className={`mt-8 p-6 rounded-lg ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-50'}`}>
        ...
        <div className="space-y-2 text-sm">
          ...
          {formData.bio && <p><span className="font-medium">Bio:</span> {formData.bio.substring(0, 100)}{formData.bio.length > 100 ? '...' : ''}</p>}
        </div>
      </div>
    </div>
  );
    ...
    <div className={`min-h-screen ${theme.bg.primary} py-8`}>
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className={`w-full bg-gray-200 ${theme.isDark ? 'bg-gray-700' : ''} rounded-full h-2`}>
            <div 
        ...
        <div className={`${theme.bg.secondary} rounded-xl shadow-lg p-8`}>
          <form onSubmit={handleSubmit}>
            ...
            {/* Navigation Buttons */}
            <div className={`flex justify-between mt-8 pt-6 border-t ${theme.border.primary}`}>
              <button
                type="button"
